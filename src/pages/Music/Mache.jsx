    ...
    return (
        <div className="band">
            ...
            <p className='bandText'>
                mâché is an indie rock band I joined when it started 2 years ago. It taught me a great deal
                ...
                <br></br><br></br>mâché has played a number of benefit, charity, and diversity shows.<br></br><br></br>Photo by Olivia Dans.
            </p>
        </div>
    )
}
